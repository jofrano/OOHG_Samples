 ...
 *
 * Este ejemplo muestra como cargar una DBF usando datos
 * tomados de una planilla Excel. También muestra como crear
 * y llenar una planilla Excel, y como manejar los errores

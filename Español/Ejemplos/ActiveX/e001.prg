 ...
 *
 * Este ejemplo muestra como utilizar la API de Google
 ...
 * https://github.com/fyurisich/OOHG_Samples/tree/master/Español/Ejemplos/ActiveX
 */
...
FUNCTION Main()
   ...
   DEFINE WINDOW Form OBJ oForm ;
      ...
      ON RELEASE FErase( CurDrive() + ':\' + CurDir() + '\temp.html' )
